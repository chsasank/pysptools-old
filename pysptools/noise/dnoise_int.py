...
class SavitzkyGolay(object):
    ...
    def plot_bands_sample(self, path, band_no, suffix=None):
        ...
        if band_no == 'all':
            ...
            plt.imshow(self.dbands[:,:,band_no])
            if suffix == None:
...
class MNF(object):
    ...
    def plot_components(self, path, n_first=None, suffix=None):
        """
        Plot some bands.
        ...
        plt.ioff()
        for i in range(n):
            plt.imshow(self.mnf[:,:,i], cmap='gray')
            if suffix == None:
    ...
    def display_components(self, n_first=None, suffix=None):
        """
        Display some bands.
