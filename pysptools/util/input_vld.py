...
class InputValidation(object):
    ...
    cmap_exist = 5
    cube_type = 1
    cube_type2 = 17 # more restricted, for HySime
    far_type = 18 # for HfcVd
    float_type = 23
    float_type2 = 24
    index_range = 8
    int_type = 13
    int_type2 = 16 # int or None
    labels_type = 9
    lib_type = 2
    list_type = 22
    mask_type = 10
    ...
    threshold_type = 3
    threshold_type2 = 12
    threshold_type3 = 19 # for AbundanceClassification
    transform_type = 15
    # new entries
    columns_type = 25
